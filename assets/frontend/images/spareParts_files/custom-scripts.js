$(document).ready(function () {
  ...
  if ($('#email-form').length) {
    $('#submit').on('click', function () {
      ...
      if (fname == '' || email == '') {
        $('#email-form .response').html('<div class="failed alert alert-warning">Silahkan isi kolom yang diperlukan.</div>');
        return false;
      }
