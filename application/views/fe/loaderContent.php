        ...
        <div class="container">
            <div class="page-top-wrap w-100">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Ban Loader</li>
                </ol>
            </div><!-- Page Top Wrap -->
        </div>
    </div>
                        ...
                        <div class="pagination-wrap">
                            ...
                            <?php 
                                ...
                                <li class="page-item active">
                                    <a class="page-link" href="<?= base_url('site/loader?page=')?>1" title="">1</a>
                                </li>
                                <li class="page-item">
                                ...
                                <li class="page-item active">
                                    <a class="page-link" href="<?= base_url('site/loader?page=')?><?= $jm+1; ?>" title=""><?= $jm+1; ?></a>
                                </li>
                                <?php } ?>
                                <li class="page-item">
                                    <a class="page-link" onclick="next()" title="">Next</a>
