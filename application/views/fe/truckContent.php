...
<section>
    <div class="w-100 pt-170 pb-50 dark-layer3 opc7 position-relative">
        <div class="fixed-bg" style="background-image: url(https://berkatpartindoabadi.com/wp-content/uploads/2022/05/BPA-1.png);"></div>
        <div class="container">
            <div class="page-top-wrap w-100">
                <h1 class="mb-0">Ban Truck</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo base_url() ?>/" title="">Beranda</a></li>
                    <li class="breadcrumb-item active">Ban Truck</li>
                </ol>
            </div><!-- Page Top Wrap -->
        </div>
    </div>
                        ...
                        <div class="pagination-wrap">
                            ...
                            <?php 
                                ...
                                <li class="page-item active">
                                    <a class="page-link" href="<?= base_url('site/truck?page=')?>1" title="">1</a>
                                </li>
                                <li class="page-item">
                                ...
                                <li class="page-item active">
                                    <a class="page-link" href="<?= base_url('site/truck?page=')?><?= $jm+1; ?>" title=""><?= $jm+1; ?></a>
                                </li>
                                <?php } ?>
                                <li class="page-item">
                                    <a class="page-link" onclick="next()" title="">Next</a>
