                        ...
                        <div class="pagination-wrap">
                            ...
                            <ul class="pagination">
                                ...
                                <li class="page-item active">
                                    <a class="page-link" href="<?= base_url('site/katalog?page=')?>1" title="">1</a>
                                </li>
                                <li class="page-item">
                                ...
                                <li class="page-item active">
                                    <a class="page-link" href="<?= base_url('site/katalog?page=')?><?= $jm+1; ?>" title=""><?= $jm+1; ?></a>
                                </li>
                                <?php } ?>
                                <li class="page-item">
                                    <a class="page-link" onclick="next()" title="">Next</a>
                                ...
                                <!-- <li class="page-item">
                                    <a class="page-link" href="<?php echo base_url() ?>spare-part/page/2" title="">2</a>
                                </li>

                                <li class="page-item">
                                    <a class="page-link" href="<?php echo base_url() ?>spare-part/page/2" title="">Next</a>
                                </li> -->
                            </ul>
