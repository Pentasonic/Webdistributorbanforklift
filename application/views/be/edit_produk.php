...
<div class="container-fluid">
    ...
    <form action="<?php echo base_url(); ?>admin/EditProdukProcess" method="post" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1">Slug Produk</span>
            </div>
            <input id="slugCheck" name="produk-slug" type="text" class="form-control" placeholder="Slug Produk" aria-label="Slug Produk" aria-describedby="basic-addon1" value="<?= $data_produk->slug; ?>">
            <div id="alert">
