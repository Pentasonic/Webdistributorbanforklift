                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5" style="margin-top: 110px;">
                                    ...
                                    <form class="user" method="post" action="<?php echo base_url(); ?>login/loginProcess">
                                        <div class="form-group">
                                            <input name="username" required type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button style="margin-top: 50px;" type="submit" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </button>
                                    </form>
                                    <hr>
