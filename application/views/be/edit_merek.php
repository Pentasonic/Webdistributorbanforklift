...
<div class="container-fluid">
    ...
    <form action="<?php echo base_url(); ?>admin/EditMerekProcess" method="post" enctype="multipart/form-data">
        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1">Nama Merek</span>
            </div>
            <input type="hidden" name="id_merek" value="<?= $merek_data->id_merek; ?>">
            <input name="nama" type="text" class="form-control" placeholder="Nama Merek" aria-label="Nama Merek" aria-describedby="basic-addon1" value="<?= $merek_data->nama_merek; ?>">
        </div>
        <div class="input-group mb-3">
            <div class="input-group-prepend">
        ...
        <span style="font-size:10px;">Width : 652px x Height 142px</span><br>
        <img src="<?= base_url($merek_data->lokasi) ?>" id="logoShow" />
